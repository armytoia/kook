...
@NgModule({
  declarations: [AppComponent, MassaGordaInicioComponent, MassaGordaMeioComponent, MassaGordaFimComponent, GraficoComponent, DicasComponent, ExercicioComponent, AlimentacaoComponent, LocalizadoComponent, AquecimentoComponent, PerdaComponent, GanhoComponent, BoaComponent, SalvarUsuarioComponent],
  entryComponents: [],
